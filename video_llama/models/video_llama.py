...
class VideoLLAMA(Blip2Base):
    ...
    def __init__(
        ...
        self.audio_encoder.load_state_dict(torch.load("{}/imagebind_huge.pth".format(imagebind_ckpt_path), map_location=torch.device("cuda:2"), mmap=True, weights_only=True))
