...
class NextQATrainDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        for _ in range(num_retries):
            ...
            sys_prompt = '''You are given video embeddings, a question, and five options of answers to the question indexed by A, B, C, D, E. Your task is to select the correct answer index from the five options of answers to the question according to the video embeddings.'''
