...
class NextQATrainDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        for _ in range(num_retries):
            ...
            sys_prompt = '''Your task is to select the correct answer index from the five options of answers indexed by A, B, C, D, E to the question according to the video embeddings.'''
