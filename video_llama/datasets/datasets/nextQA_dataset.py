...
class NextQATrainDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        for _ in range(num_retries):
            ...
            sys_prompt = '''You are given video_embeddings called real_video_embeddings, a question called real_question, and five options of answers to real_question called real_answers. Your task is to select the correct answer from the real_answers to the real_question according to the real_video_embeddings. Make sure your answer is concise with short explanation and mention the index of the answer.'''
