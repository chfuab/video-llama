...
if __name__ == '__main__':
    ...
    sys_prompt = "You are given a question. Your task is to answer the question. Your answer should be of one sentence long. If you don't know the answer, explain why."
